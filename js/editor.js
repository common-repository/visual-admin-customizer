...
require(
	...
	jQuery(function ($) {
		...
		function onChildFrameLoaded() {
			...
			var injectedScriptUrl = editorData['pluginBaseUrl'] + 'js/inject.js?ver=20190606';
		...
		const frameDocument = $childFrame.get(0).contentDocument;
		if (frameDocument.readyState === 'complete') {
			onChildFrameLoaded();
		}
		$childFrame.on('load', onChildFrameLoaded);
